...
namespace lve {
	...
	void LveRenderer::begiSwapChainRenderPass(VkCommandBuffer commandBuffer) {
		...
		assert(commandBuffer == getCurrentCommandBuffer() && "Can't start render pass on commandBuffer from a different frame");
	...
	void LveRenderer::endSwapChainRenderPass(VkCommandBuffer commandBuffer) {
		...
		assert(commandBuffer == getCurrentCommandBuffer() && "Can't end render pass on commandBuffer from a different frame");
